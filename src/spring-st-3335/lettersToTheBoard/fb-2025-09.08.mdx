...
This house was originally built as a 3 bedroom/2 bath, then sold as a 5 bedroom/4 bathroom in 2024. I don’t see any permit for the 3 additional bedrooms, only a permit to add a study room, but not a bedroom. **How can the county legally purchase a home without correct permits? (see attached)**
